...
const Register = () => {
  ...
  const { mutate, isLoading } = useMutation({
    mutationFn: postRegsiter,
    mutationKey: "register",
  });

  const handleSubmit = async (e) => {
    // check datasubmit if one of the value is empty
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button
                      className="block w-full max-w-xs mx-auto bg-primary hover:bg-primary-hover focus:bg-primary text-white rounded-lg px-3 py-3 font-semibold"
